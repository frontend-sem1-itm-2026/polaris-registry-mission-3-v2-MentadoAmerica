document.addEventListener('DOMContentLoaded', () => {
  ...
  // ========== 6. Validación individual de un campo ==========
  const validateSingleField = (rule) => {
    let isValid;
    if (rule.id === 'current-role') {
      // Validación especial sin input específico
  ...
  // Nombre completo: validar al cambiar cualquiera de los tres
